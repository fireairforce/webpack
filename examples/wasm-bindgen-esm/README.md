...
chunk (runtime: main) output.js (main) 3.03 KiB (javascript) 14.8 KiB (webassembly) 3.75 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 3.75 KiB 6 modules
...
asset output.js 3.36 KiB [emitted] [minimized] (name: main)
chunk (runtime: main) output.js (main) 3.03 KiB (javascript) 14.8 KiB (webassembly) 3.48 KiB (runtime) [entry] [rendered]
  > ./example.js main
