...
```
asset output.js 6.93 KiB [emitted] [javascript module] (name: main)
...
```
asset output.js 1.22 KiB [emitted] [javascript module] [minimized] (name: main)
