...
chunk (runtime: main) output.js (main) 1.27 KiB (javascript) 170 bytes (webassembly) 3.75 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
```
asset output.js 2.83 KiB [emitted] [minimized] (name: main)
