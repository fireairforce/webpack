...
chunk (runtime: runtime) runtime.js (runtime) 6.76 KiB ={other-vendors}= ={react-vendors}= >{app}< >{page1}< [entry] [rendered]
  > ./other-vendors other-vendors
  > prop-types react-vendors
  > react react-vendors
  > react-dom react-vendors
  runtime modules 6.76 KiB 10 modules
...
```
asset runtime.js 2.43 KiB [emitted] [minimized] (name: runtime)
...
Entrypoint react-vendors 2.63 KiB = runtime.js 2.43 KiB react-vendors.js 201 bytes
Entrypoint other-vendors 2.67 KiB = runtime.js 2.43 KiB other-vendors.js 236 bytes
chunk (runtime: runtime) app.js (app) 116 bytes <{other-vendors}> <{runtime}> >{page1}< [initial] [rendered]
  > ./app.js app
  ./app.js 116 bytes [built] [code generated]
    [no exports]
