...
asset output.js 15.5 KiB [emitted] (name: main) 1 related asset
...
chunk (runtime: main) output.js (main) 325 bytes (javascript) 4 bytes (asset) 7.74 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
assets by path *.js 3.23 KiB
  asset output.js 3.04 KiB [emitted] [minimized] (name: main) 1 related asset
...
chunk (runtime: main) async_js.f5b4307c4a15ad5435bd.js 24 bytes [rendered]
  ...
  ./async.js 24 bytes [built] [code generated]
    [exports: default]
    import() ./async.js ./example.js 6:8-28
chunk (runtime: main) output.js (main) 283 bytes (javascript) 7.65 KiB (runtime) [entry] [rendered]
  > ./example.js main
